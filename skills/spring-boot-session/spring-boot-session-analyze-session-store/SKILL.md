---
name: spring-boot-session-analyze-session-store
description: Analyze Spring Session store configuration, Redis/JDBC-backed sessions, serialization, TTL, and session consistency. Use for Spring Boot session design, implementation review, or runtime diagnosis.
---

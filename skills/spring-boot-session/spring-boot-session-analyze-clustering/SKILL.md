---
name: spring-boot-session-analyze-clustering
description: Analyze session behavior across scaled Spring Boot instances, load balancing, failover, and statelessness assumptions. Use for Spring Boot session design, implementation review, or runtime diagnosis.
---

# Analyze Session Clustering

---
name: spring-boot-session-diagnose-session-loss
description: Diagnose missing or inconsistent sessions across application instances, store failures, TTLs, cookies, and network paths. Use for Spring Boot session design, implementation review, or runtime diagnosis.
---

# Diagnose Session Loss

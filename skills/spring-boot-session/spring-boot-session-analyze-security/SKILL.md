---
name: spring-boot-session-analyze-security
description: Analyze session fixation, cookie settings, invalidation, concurrent sessions, CSRF relationships, and session security. Use for Spring Boot session design, implementation review, or runtime diagnosis.
---

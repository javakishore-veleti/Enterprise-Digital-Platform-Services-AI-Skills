---
name: spring-boot-diagnostics-analyze-thread-dump
description: Analyze Spring Boot JVM thread dumps for deadlocks, blocked threads, pool saturation, request stalls, and dependency waits. Use for Spring Boot diagnostics engineering, architecture, or runtime diagnosis.
---

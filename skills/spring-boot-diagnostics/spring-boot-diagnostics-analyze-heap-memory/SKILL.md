---
name: spring-boot-diagnostics-analyze-heap-memory
description: Analyze Spring Boot JVM heap, GC pressure, memory leaks, object retention symptoms, OOM events, and container memory interactions. Use for Spring Boot diagnostics engineering, architecture, or runtime diagnosis.
---

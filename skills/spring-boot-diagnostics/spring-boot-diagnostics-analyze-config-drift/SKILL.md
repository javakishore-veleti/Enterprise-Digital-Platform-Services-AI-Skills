---
name: spring-boot-diagnostics-analyze-config-drift
description: Analyze configuration drift between environments, repositories, deployment descriptors, environment variables, and runtime-effective settings. Use for Spring Boot diagnostics engineering, architecture, or runtime diagnosis.
---

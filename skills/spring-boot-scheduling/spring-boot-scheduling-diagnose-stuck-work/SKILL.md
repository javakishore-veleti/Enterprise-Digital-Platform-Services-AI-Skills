---
name: spring-boot-scheduling-diagnose-stuck-work
description: Diagnose stuck or delayed background work using thread pools, queues, locks, downstream calls, and runtime telemetry. Use for Spring Boot scheduling engineering, architecture, or runtime diagnosis.
---

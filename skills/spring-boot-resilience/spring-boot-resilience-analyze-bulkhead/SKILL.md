---
name: spring-boot-resilience-analyze-bulkhead
description: Analyze concurrency isolation, thread-pool or semaphore bulkheads, saturation, queueing, and failure containment. Use for Spring Boot resilience engineering, architecture, validation, or runtime diagnosis.
---

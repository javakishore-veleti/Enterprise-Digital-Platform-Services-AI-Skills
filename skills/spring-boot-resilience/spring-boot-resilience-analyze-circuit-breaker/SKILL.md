---
name: spring-boot-resilience-analyze-circuit-breaker
description: Analyze circuit breaker thresholds, state transitions, fallback behavior, metrics, and dependency protection. Use for Spring Boot resilience engineering, architecture, validation, or runtime diagnosis.
---

---
name: spring-boot-resilience-analyze-retries
description: Analyze retry policies, backoff, jitter, idempotency, retry storms, and interaction with upstream/downstream timeouts. Use for Spring Boot resilience engineering, architecture, validation, or runtime diagnosis.
---

---
name: spring-boot-integration-analyze-adapter
description: Analyze Spring Integration inbound/outbound adapters, gateways, polling, acknowledgements, and external system behavior. Use for Spring Boot integration engineering, architecture, or runtime diagnosis.
---

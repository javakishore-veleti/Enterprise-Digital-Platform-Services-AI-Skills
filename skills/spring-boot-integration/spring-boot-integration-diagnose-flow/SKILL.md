---
name: spring-boot-integration-diagnose-flow
description: Diagnose Spring Integration failures across channels, handlers, adapters, routing, correlation, timeouts, and downstream systems. Use for Spring Boot integration engineering, architecture, or runtime diagnosis.
---

# Diagnose Integration Flow

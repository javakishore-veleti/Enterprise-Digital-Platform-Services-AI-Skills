---
name: spring-boot-integration-analyze-routing
description: Analyze content-based routing, recipient lists, filters, splitters, aggregators, and message correlation. Use for Spring Boot integration engineering, architecture, or runtime diagnosis.
---

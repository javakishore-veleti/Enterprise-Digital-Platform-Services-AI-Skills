---
name: spring-boot-integration-analyze-flow
description: Analyze Spring Integration channels, endpoints, transformers, routers, filters, service activators, and message flow. Use for Spring Boot integration engineering, architecture, or runtime diagnosis.
---

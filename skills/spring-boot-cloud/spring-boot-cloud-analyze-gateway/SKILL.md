---
name: spring-boot-cloud-analyze-gateway
description: Analyze Spring Cloud Gateway routes, predicates, filters, headers, retries, timeouts, security, and routing failures. Use for Spring Boot cloud engineering, architecture, or runtime diagnosis.
---

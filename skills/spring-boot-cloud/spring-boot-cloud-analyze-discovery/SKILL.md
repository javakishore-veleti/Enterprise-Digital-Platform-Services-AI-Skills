---
name: spring-boot-cloud-analyze-discovery
description: Analyze service discovery registration, lookup, health, stale instances, DNS/service registry behavior, and client impact. Use for Spring Boot cloud engineering, architecture, or runtime diagnosis.
---

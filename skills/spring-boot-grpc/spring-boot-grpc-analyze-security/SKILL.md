---
name: spring-boot-grpc-analyze-security
description: Analyze gRPC TLS/mTLS, authentication metadata, authorization interceptors, certificate trust, and service identity. Use for Spring Boot grpc design, implementation review, or runtime diagnosis.
---

# Analyze gRPC Security

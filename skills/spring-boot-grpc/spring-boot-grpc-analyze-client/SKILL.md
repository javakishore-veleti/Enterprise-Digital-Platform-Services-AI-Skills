---
name: spring-boot-grpc-analyze-client
description: Analyze Spring gRPC clients, channels, deadlines, retries, load balancing, TLS, and downstream failures. Use for Spring Boot grpc design, implementation review, or runtime diagnosis.
---

---
name: spring-boot-grpc-analyze-streaming
description: Analyze unary, server-streaming, client-streaming, and bidirectional streaming behavior, flow control, cancellation, and backpressure. Use for Spring Boot grpc design, implementation review, or runtime diagnosis.
---

# Analyze gRPC Streaming

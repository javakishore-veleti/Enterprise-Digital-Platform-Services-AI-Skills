---
name: spring-boot-grpc-analyze-contract
description: Analyze protobuf contracts, service methods, messages, compatibility, field evolution, and code generation expectations. Use for Spring Boot grpc design, implementation review, or runtime diagnosis.
---

# Analyze gRPC Contract

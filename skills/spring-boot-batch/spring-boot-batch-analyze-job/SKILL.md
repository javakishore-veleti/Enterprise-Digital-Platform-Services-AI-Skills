---
name: spring-boot-batch-analyze-job
description: Analyze Spring Batch jobs, steps, job parameters, restartability, execution state, and failure behavior. Use for Spring Boot batch engineering, architecture, or runtime diagnosis.
---

---
name: spring-boot-batch-analyze-partitioning
description: Analyze Spring Batch partitioning, remote partitioning, worker scaling, data distribution, and restart behavior. Use for Spring Boot batch engineering, architecture, or runtime diagnosis.
---

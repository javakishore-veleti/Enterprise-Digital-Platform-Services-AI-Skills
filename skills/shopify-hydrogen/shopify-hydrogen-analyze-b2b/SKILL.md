---
name: shopify-hydrogen-analyze-b2b
description: Analyze Shopify B2B behavior in Hydrogen including authenticated company customers, buyer context, catalogs, pricing, locations, cart association, and Customer Account API integration. Use for Shopify Hydrogen headless commerce architecture, implementation review, production diagnosis, or modernization.
---

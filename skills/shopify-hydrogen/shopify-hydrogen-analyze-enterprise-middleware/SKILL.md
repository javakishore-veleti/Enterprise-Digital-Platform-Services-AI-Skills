---
name: shopify-hydrogen-analyze-enterprise-middleware
description: Analyze Hydrogen integration with enterprise API middleware and microservices, including orchestration boundaries, API contracts, identity propagation, latency, resilience, caching, and evidence correlation. Use for Shopify Hydrogen headless commerce architecture, implementation review, production diagnosis, or modernization.
---

# Analyze Enterprise Middleware

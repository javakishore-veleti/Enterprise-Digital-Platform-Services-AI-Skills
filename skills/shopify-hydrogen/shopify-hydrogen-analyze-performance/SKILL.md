---
name: shopify-hydrogen-analyze-performance
description: Analyze Hydrogen storefront performance including TTFB, LCP, INP, CLS, SSR, data-loading waterfalls, GraphQL payloads, caching, JavaScript, images, and third-party scripts. Use for Shopify Hydrogen headless commerce architecture, implementation review, production diagnosis, or modernization.
---

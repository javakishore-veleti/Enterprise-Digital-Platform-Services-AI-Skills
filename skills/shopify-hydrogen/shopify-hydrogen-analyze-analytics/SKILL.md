---
name: shopify-hydrogen-analyze-analytics
description: Analyze Hydrogen analytics architecture, Shopify analytics components/events, consent, customer privacy, page/product/cart/checkout events, and third-party analytics integration. Use for Shopify Hydrogen headless commerce architecture, implementation review, production diagnosis, or modernization.
---

---
name: shopify-hydrogen-inspect-storefront
description: Inspect a Shopify Hydrogen headless storefront across React Router architecture, Shopify API clients, routes, loaders/actions, cart, customer accounts, caching, Oxygen, environments, Markets, analytics, SEO, and enterprise integrations. Use for Shopify Hydrogen headless commerce architecture, implementation review, production diagnosis, or modernization.
---

---
name: shopify-hydrogen-analyze-security
description: Analyze Hydrogen security across Storefront/Customer Account API credentials, sessions, cookies, CSRF-like action protections, headers, secrets, PII, third-party calls, and storefront exposure. Use for Shopify Hydrogen headless commerce architecture, implementation review, production diagnosis, or modernization.
---

---
name: shopify-hydrogen-analyze-search
description: Analyze Shopify storefront search and predictive-search implementations in Hydrogen, query behavior, result types, pagination, UX, caching, and performance. Use for Shopify Hydrogen headless commerce architecture, implementation review, production diagnosis, or modernization.
---

---
name: shopify-hydrogen-analyze-seo
description: Analyze Hydrogen SEO using current metadata utilities, canonical URLs, robots, sitemaps, structured data, product/collection metadata, social previews, and indexing behavior. Use for Shopify Hydrogen headless commerce architecture, implementation review, production diagnosis, or modernization.
---

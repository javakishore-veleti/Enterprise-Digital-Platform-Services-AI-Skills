---
name: shopify-hydrogen-analyze-storefront-api
description: Analyze Shopify Storefront GraphQL API queries, mutations, fragments, variables, payload size, errors, throttling/cost, API versions, and Hydrogen client usage. Use for Shopify Hydrogen headless commerce architecture, implementation review, production diagnosis, or modernization.
---

# Analyze Storefront API

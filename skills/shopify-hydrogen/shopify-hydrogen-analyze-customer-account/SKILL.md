---
name: shopify-hydrogen-analyze-customer-account
description: Analyze Shopify Customer Account API authentication, OAuth authorization flow, sessions, customer queries, order history, B2B behavior, and privacy-safe caching. Use for Shopify Hydrogen headless commerce architecture, implementation review, production diagnosis, or modernization.
---

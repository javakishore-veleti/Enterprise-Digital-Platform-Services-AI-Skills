---
name: shopify-hydrogen-analyze-api-version-upgrade
description: Analyze Shopify Storefront API, Customer Account API, and Hydrogen package version upgrades, deprecated fields/components, generated types, compatibility, testing, and migration work. Use for Shopify Hydrogen headless commerce architecture, implementation review, production diagnosis, or modernization.
---

# Analyze API Version Upgrade

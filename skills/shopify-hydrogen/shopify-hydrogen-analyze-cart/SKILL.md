---
name: shopify-hydrogen-analyze-cart
description: Analyze Hydrogen server-side cart architecture, cart handler, CartForm actions, add/update/remove lines, buyer identity, discounts, checkout URLs, optimistic UI, and cart failures. Use for Shopify Hydrogen headless commerce architecture, implementation review, production diagnosis, or modernization.
---

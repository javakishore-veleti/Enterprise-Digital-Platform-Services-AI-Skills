---
name: shopify-hydrogen-analyze-product-page
description: Analyze Hydrogen product-detail routes, variants, selected options, product GraphQL fragments, availability, pricing, media, SEO, and cart integration. Use for Shopify Hydrogen headless commerce architecture, implementation review, production diagnosis, or modernization.
---

---
name: shopify-hydrogen-analyze-testing
description: Analyze Hydrogen testing across routes, loaders/actions, GraphQL contracts, cart/customer flows, browser tests, mocks, API-version regressions, and production-like environments. Use for Shopify Hydrogen headless commerce architecture, implementation review, production diagnosis, or modernization.
---

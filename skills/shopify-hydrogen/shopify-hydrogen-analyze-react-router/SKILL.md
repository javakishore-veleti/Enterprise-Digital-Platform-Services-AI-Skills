---
name: shopify-hydrogen-analyze-react-router
description: Analyze current Hydrogen React Router application structure, route modules, loaders, actions, SSR, deferred data, navigation, error boundaries, and server/client behavior. Use for Shopify Hydrogen headless commerce architecture, implementation review, production diagnosis, or modernization.
---

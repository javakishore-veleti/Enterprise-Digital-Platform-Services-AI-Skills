---
name: shopify-hydrogen-analyze-environments
description: Analyze Hydrogen environment configuration, storefront linking, Shopify-generated variables, custom variables, sessions, secrets, and environment drift across local and Oxygen deployments. Use for Shopify Hydrogen headless commerce architecture, implementation review, production diagnosis, or modernization.
---

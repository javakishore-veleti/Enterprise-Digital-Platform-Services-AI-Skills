---
name: shopify-hydrogen-analyze-images
description: Analyze Hydrogen image delivery, responsive sizing, Shopify CDN usage, loading priority, aspect ratios, lazy loading, and Core Web Vitals impact. Use for Shopify Hydrogen headless commerce architecture, implementation review, production diagnosis, or modernization.
---

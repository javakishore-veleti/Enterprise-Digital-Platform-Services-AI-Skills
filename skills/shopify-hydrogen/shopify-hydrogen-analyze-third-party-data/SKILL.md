---
name: shopify-hydrogen-analyze-third-party-data
description: Analyze Hydrogen integration with CMS, ERP, inventory, loyalty, recommendations, and other third-party APIs using server-side clients, parallel loading, caching, error isolation, and data composition. Use for Shopify Hydrogen headless commerce architecture, implementation review, production diagnosis, or modernization.
---

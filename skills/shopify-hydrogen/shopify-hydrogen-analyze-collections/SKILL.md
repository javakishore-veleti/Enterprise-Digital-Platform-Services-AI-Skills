---
name: shopify-hydrogen-analyze-collections
description: Analyze Hydrogen collection/listing routes, pagination, filters, sorting, product cards, GraphQL query efficiency, caching, and navigation. Use for Shopify Hydrogen headless commerce architecture, implementation review, production diagnosis, or modernization.
---

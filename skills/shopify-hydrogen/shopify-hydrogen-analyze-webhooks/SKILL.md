---
name: shopify-hydrogen-analyze-webhooks
description: Analyze enterprise Shopify webhook ingestion used by Hydrogen ecosystems, including topic selection, verification, idempotency, ordering, retries, event persistence, and downstream processing. Use for Shopify Hydrogen headless commerce architecture, implementation review, production diagnosis, or modernization.
---

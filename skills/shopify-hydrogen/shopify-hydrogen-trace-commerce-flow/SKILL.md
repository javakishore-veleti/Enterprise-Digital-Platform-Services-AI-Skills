---
name: shopify-hydrogen-trace-commerce-flow
description: Trace a Hydrogen commerce flow end-to-end from browser route through loader/action, Shopify APIs, cart/customer context, enterprise middleware, downstream systems, and rendered response. Use for Shopify Hydrogen headless commerce architecture, implementation review, production diagnosis, or modernization.
---

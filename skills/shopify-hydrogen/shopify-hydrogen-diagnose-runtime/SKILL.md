---
name: shopify-hydrogen-diagnose-runtime
description: Diagnose Shopify Hydrogen storefront failures across routes, loaders/actions, Storefront API, Customer Account API, cart, caching, Oxygen, sessions, third-party APIs, and enterprise middleware. Use for Shopify Hydrogen headless commerce architecture, implementation review, production diagnosis, or modernization.
---

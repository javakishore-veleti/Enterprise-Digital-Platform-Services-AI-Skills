---
name: spring-boot-modulith-analyze-modules
description: Analyze Spring Modulith application modules, package boundaries, dependencies, exposed interfaces, and architecture violations. Use for Spring Boot modulith engineering, architecture, or runtime diagnosis.
---

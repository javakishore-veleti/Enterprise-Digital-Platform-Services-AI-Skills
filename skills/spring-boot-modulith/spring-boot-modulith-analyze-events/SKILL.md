---
name: spring-boot-modulith-analyze-events
description: Analyze Spring Modulith application events, publication lifecycle, transactional event behavior, retries, and module decoupling. Use for Spring Boot modulith engineering, architecture, or runtime diagnosis.
---

# Analyze Module Events

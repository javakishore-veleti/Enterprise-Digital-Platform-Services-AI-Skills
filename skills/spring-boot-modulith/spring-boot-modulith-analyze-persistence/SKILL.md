---
name: spring-boot-modulith-analyze-persistence
description: Analyze Spring Modulith event publication persistence, completion tracking, recovery, and operational behavior. Use for Spring Boot modulith engineering, architecture, or runtime diagnosis.
---

# Analyze Event Persistence

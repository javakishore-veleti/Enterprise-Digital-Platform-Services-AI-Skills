---
name: spring-boot-modulith-verify-architecture
description: Verify Spring Modulith structural rules, module dependencies, cycles, documentation, and architecture tests. Use for Spring Boot modulith engineering, architecture, or runtime diagnosis.
---

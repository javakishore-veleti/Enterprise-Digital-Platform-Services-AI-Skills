---
name: spring-boot-native-diagnose-build
description: Diagnose Spring Boot native-image build failures, unsupported reflection/resources, dependencies, buildpacks, and toolchain issues. Use for Spring Boot native engineering, architecture, or runtime diagnosis.
---

# Diagnose Native Build

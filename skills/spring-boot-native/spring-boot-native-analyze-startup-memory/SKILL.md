---
name: spring-boot-native-analyze-startup-memory
description: Analyze JVM versus native startup time, memory footprint, warmup, image size, and workload tradeoffs. Use for Spring Boot native engineering, architecture, or runtime diagnosis.
---

# Analyze Startup Memory

---
name: spring-boot-native-analyze-graalvm
description: Analyze GraalVM native image builds, reflection/resource/proxy hints, reachability metadata, and runtime differences. Use for Spring Boot native engineering, architecture, or runtime diagnosis.
---

# Analyze GraalVM Native

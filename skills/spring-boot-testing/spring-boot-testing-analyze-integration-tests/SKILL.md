---
name: spring-boot-testing-analyze-integration-tests
description: Analyze Spring Boot integration tests, application context, Testcontainers, external dependencies, and environment fidelity. Use for Spring Boot testing engineering, architecture, validation, or runtime diagnosis.
---

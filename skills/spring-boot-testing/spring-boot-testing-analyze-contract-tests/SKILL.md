---
name: spring-boot-testing-analyze-contract-tests
description: Analyze API/message contract tests, compatibility, provider/consumer expectations, schema evolution, and CI integration. Use for Spring Boot testing engineering, architecture, validation, or runtime diagnosis.
---

# Analyze Contract Tests

---
name: spring-boot-testing-analyze-slice-tests
description: Analyze Spring test slices such as WebMvcTest and DataJpaTest, context scope, mocks, and false confidence risks. Use for Spring Boot testing engineering, architecture, validation, or runtime diagnosis.
---

---
name: spring-boot-testing-analyze-unit-tests
description: Analyze Spring Boot unit tests, isolation, mocking, deterministic behavior, assertions, and coverage quality. Use for Spring Boot testing engineering, architecture, validation, or runtime diagnosis.
---

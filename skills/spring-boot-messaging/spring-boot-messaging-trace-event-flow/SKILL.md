---
name: spring-boot-messaging-trace-event-flow
description: Trace an event from producer through broker/stream, consumer, business processing, retries, and downstream side effects. Use for Spring Boot messaging engineering, architecture, or runtime diagnosis.
---

---
name: spring-boot-messaging-analyze-consumer
description: Analyze Spring Boot consumers/listeners, concurrency, acknowledgements, retries, backpressure, error handling, and processing failures. Use for Spring Boot messaging engineering, architecture, or runtime diagnosis.
---

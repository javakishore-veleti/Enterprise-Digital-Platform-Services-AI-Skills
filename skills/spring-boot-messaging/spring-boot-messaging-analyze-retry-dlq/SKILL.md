---
name: spring-boot-messaging-analyze-retry-dlq
description: Analyze retry, backoff, dead-letter queue/topic, poison-message handling, idempotency, and replay patterns. Use for Spring Boot messaging engineering, architecture, or runtime diagnosis.
---

---
name: spring-boot-messaging-analyze-producer
description: Analyze Spring Boot message producers, serialization, batching, retries, idempotence, transaction boundaries, and publish failures. Use for Spring Boot messaging engineering, architecture, or runtime diagnosis.
---

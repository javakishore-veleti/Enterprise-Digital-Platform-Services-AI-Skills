---
name: spring-boot-messaging-analyze-contract
description: Analyze event/message schemas, serialization, compatibility, headers, correlation IDs, and consumer evolution. Use for Spring Boot messaging engineering, architecture, or runtime diagnosis.
---

# Analyze Message Contract

---
name: spring-boot-ai-analyze-tools
description: Analyze Spring AI tool/function calling, schemas, tool selection, failures, security boundaries, and side effects. Use for Spring Boot ai design, implementation review, or runtime diagnosis.
---

---
name: spring-boot-ai-analyze-observability
description: Analyze Spring AI latency, token usage, model errors, retrieval spans, tool calls, and observability integration. Use for Spring Boot ai design, implementation review, or runtime diagnosis.
---

# Analyze AI Observability

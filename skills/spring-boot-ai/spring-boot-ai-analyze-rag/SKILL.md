---
name: spring-boot-ai-analyze-rag
description: Analyze Spring AI RAG pipelines including ingestion, chunking, embeddings, vector stores, retrieval, reranking, grounding, and evaluation. Use for Spring Boot ai design, implementation review, or runtime diagnosis.
---

---
name: spring-boot-ai-analyze-model-client
description: Analyze Spring AI model client configuration, providers, timeouts, retries, structured output, and runtime failures. Use for Spring Boot ai design, implementation review, or runtime diagnosis.
---

# Analyze Model Client

---
name: spring-boot-graphql-diagnose-request
description: Diagnose GraphQL request failures across parsing, validation, resolvers, data loaders, downstream systems, and response errors. Use for Spring Boot graphql design, implementation review, or runtime diagnosis.
---

# Diagnose GraphQL Request

---
name: spring-boot-graphql-analyze-data-fetcher
description: Analyze GraphQL controllers/data fetchers, argument binding, exceptions, context, and resolver behavior. Use for Spring Boot graphql design, implementation review, or runtime diagnosis.
---

# Analyze Data Fetcher

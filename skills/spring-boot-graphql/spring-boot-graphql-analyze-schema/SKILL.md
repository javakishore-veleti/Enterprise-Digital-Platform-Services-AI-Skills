---
name: spring-boot-graphql-analyze-schema
description: Analyze Spring for GraphQL schemas, types, fields, nullability, input/output contracts, and schema evolution. Use for Spring Boot graphql design, implementation review, or runtime diagnosis.
---

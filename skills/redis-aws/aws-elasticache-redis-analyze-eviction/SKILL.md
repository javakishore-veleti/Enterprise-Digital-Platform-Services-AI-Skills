---
name: aws-elasticache-redis-analyze-eviction
description: Analyze Redis OSS or Valkey eviction policy behavior in ElastiCache, memory pressure, expiration patterns, workload semantics, and data-loss expectations. Use for AWS ElastiCache engineering, architecture, operations, or incident analysis when Redis OSS or Valkey compatibility is material to the task.
---

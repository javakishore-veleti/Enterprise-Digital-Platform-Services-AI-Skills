---
name: aws-elasticache-redis-analyze-streams
description: Analyze Redis Streams on ElastiCache including consumer groups, pending entries, acknowledgements, trimming, lag, retries, idempotency, and workload suitability. Use for AWS ElastiCache engineering, architecture, operations, or incident analysis when Redis OSS or Valkey compatibility is material to the task.
---

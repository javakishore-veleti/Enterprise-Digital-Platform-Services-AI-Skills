---
name: aws-elasticache-redis-analyze-terraform
description: Analyze Terraform for ElastiCache replication groups, Serverless caches, subnet groups, parameter groups, users/user groups, security, encryption, snapshots, and Global Datastore configuration. Use for AWS ElastiCache engineering, architecture, operations, or incident analysis when Redis OSS or Valkey compatibility is material to the task.
---

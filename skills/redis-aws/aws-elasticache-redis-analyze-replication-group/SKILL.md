---
name: aws-elasticache-redis-analyze-replication-group
description: Analyze node-based ElastiCache replication groups including primaries, replicas, asynchronous replication, Multi-AZ automatic failover, endpoints, shard topology, and replica health. Use for AWS ElastiCache engineering, architecture, operations, or incident analysis when Redis OSS or Valkey compatibility is material to the task.
---

# Analyze Replication Group

---
name: aws-elasticache-redis-analyze-performance
description: Analyze ElastiCache throughput and latency using engine CPU, server load, memory, network, command patterns, connection counts, hot keys, large values, replication, and client evidence. Use for AWS ElastiCache engineering, architecture, operations, or incident analysis when Redis OSS or Valkey compatibility is material to the task.
---

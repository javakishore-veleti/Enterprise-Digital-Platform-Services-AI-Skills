---
name: aws-elasticache-redis-analyze-spring-boot
description: Analyze Spring Boot and Java integration with ElastiCache using Lettuce or Jedis, Spring Cache, TLS, IAM authentication, RBAC, cluster topology, pooling, timeouts, and resilience. Use for AWS ElastiCache engineering, architecture, operations, or incident analysis when Redis OSS or Valkey compatibility is material to the task.
---

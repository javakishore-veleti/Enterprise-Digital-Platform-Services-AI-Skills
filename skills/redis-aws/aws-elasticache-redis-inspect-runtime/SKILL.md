---
name: aws-elasticache-redis-inspect-runtime
description: Inspect Amazon ElastiCache for Valkey or Redis OSS across node-based replication groups and Serverless caches, including engine/version, topology, shards, replicas, VPC, authentication, encryption, snapshots, monitoring, and application context. Use for AWS ElastiCache engineering, architecture, operations, or incident analysis when Redis OSS or Valkey compatibility is material to the task.
---

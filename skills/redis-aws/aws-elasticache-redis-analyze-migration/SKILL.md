---
name: aws-elasticache-redis-analyze-migration
description: Analyze migrations to or between ElastiCache Redis OSS and Valkey deployments, including node-based and Serverless targets, compatibility, topology, authentication, validation, cutover, and rollback. Use for AWS ElastiCache engineering, architecture, operations, or incident analysis when Redis OSS or Valkey compatibility is material to the task.
---

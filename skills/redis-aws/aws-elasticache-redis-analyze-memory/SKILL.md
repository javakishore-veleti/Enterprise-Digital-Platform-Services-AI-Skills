---
name: aws-elasticache-redis-analyze-memory
description: Analyze ElastiCache memory usage, fragmentation, keyspace growth, TTL coverage, large keys, replica memory pressure, and node or serverless capacity risk. Use for AWS ElastiCache engineering, architecture, operations, or incident analysis when Redis OSS or Valkey compatibility is material to the task.
---

---
name: aws-elasticache-redis-analyze-cache
description: Analyze ElastiCache cache-aside and application caching behavior including TTLs, hit ratio, misses, stale data, invalidation, stampedes, key design, and backend interaction. Use for AWS ElastiCache engineering, architecture, operations, or incident analysis when Redis OSS or Valkey compatibility is material to the task.
---

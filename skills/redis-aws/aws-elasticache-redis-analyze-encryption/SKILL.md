---
name: aws-elasticache-redis-analyze-encryption
description: Analyze ElastiCache encryption in transit and at rest, TLS client behavior, KMS customer-managed keys where supported, certificate trust, and related access failures. Use for AWS ElastiCache engineering, architecture, operations, or incident analysis when Redis OSS or Valkey compatibility is material to the task.
---

---
name: aws-elasticache-redis-analyze-serverless
description: Analyze Amazon ElastiCache Serverless for Valkey or Redis OSS including usage limits, scaling behavior, VPC access, IAM/RBAC authentication, snapshots, workload fit, and operational constraints. Use for AWS ElastiCache engineering, architecture, operations, or incident analysis when Redis OSS or Valkey compatibility is material to the task.
---

---
name: aws-elasticache-redis-analyze-locking
description: Analyze distributed locking patterns on ElastiCache including single-instance SET NX PX patterns, multi-node assumptions, lease safety, fencing, retries, and ETL or worker coordination. Use for AWS ElastiCache engineering, architecture, operations, or incident analysis when Redis OSS or Valkey compatibility is material to the task.
---

# Analyze Distributed Locking

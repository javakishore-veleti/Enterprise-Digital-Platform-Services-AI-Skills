---
name: aws-elasticache-redis-analyze-pubsub
description: Analyze Redis Pub/Sub on ElastiCache including subscriber lifecycle, reconnect behavior, message-loss expectations, scaling, and suitability for microservice notifications. Use for AWS ElastiCache engineering, architecture, operations, or incident analysis when Redis OSS or Valkey compatibility is material to the task.
---

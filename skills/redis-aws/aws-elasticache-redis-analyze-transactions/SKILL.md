---
name: aws-elasticache-redis-analyze-transactions
description: Analyze Redis transactions, WATCH, MULTI/EXEC, pipelining, Lua or server-side atomic operations, concurrency, and correctness on ElastiCache. Use for AWS ElastiCache engineering, architecture, operations, or incident analysis when Redis OSS or Valkey compatibility is material to the task.
---

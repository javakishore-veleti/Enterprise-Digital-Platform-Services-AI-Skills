---
name: aws-elasticache-redis-analyze-cost
description: Analyze ElastiCache cost drivers across node-based versus Serverless, node families, replicas, shards, Global Datastore, snapshots, data transfer, and workload utilization. Use for AWS ElastiCache engineering, architecture, operations, or incident analysis when Redis OSS or Valkey compatibility is material to the task.
---

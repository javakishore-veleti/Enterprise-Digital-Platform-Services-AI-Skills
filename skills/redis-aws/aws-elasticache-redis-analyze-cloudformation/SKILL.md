---
name: aws-elasticache-redis-analyze-cloudformation
description: Analyze CloudFormation for ElastiCache replication groups, Serverless caches, networking, user groups, encryption, parameters, snapshots, and lifecycle behavior. Use for AWS ElastiCache engineering, architecture, operations, or incident analysis when Redis OSS or Valkey compatibility is material to the task.
---

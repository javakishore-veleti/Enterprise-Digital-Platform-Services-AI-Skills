---
name: aws-elasticache-redis-analyze-global-datastore
description: Analyze ElastiCache Global Datastore cross-region asynchronous replication, regional read replicas, replication lag, disaster recovery, promotion, and application routing. Use for AWS ElastiCache engineering, architecture, operations, or incident analysis when Redis OSS or Valkey compatibility is material to the task.
---

# Analyze Global Datastore

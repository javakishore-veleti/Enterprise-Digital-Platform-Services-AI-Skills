---
name: aws-elasticache-redis-diagnose-runtime
description: Diagnose Amazon ElastiCache Redis OSS or Valkey incidents across clients, latency, timeouts, memory, CPU, server load, replication, failover, shards, networking, IAM/RBAC, and application telemetry. Use for AWS ElastiCache engineering, architecture, operations, or incident analysis when Redis OSS or Valkey compatibility is material to the task.
---

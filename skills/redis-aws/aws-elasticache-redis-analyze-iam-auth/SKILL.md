---
name: aws-elasticache-redis-analyze-iam-auth
description: Analyze ElastiCache IAM authentication for Valkey or Redis OSS, ElastiCache users, RBAC, elasticache:Connect permissions, token lifecycle, TLS requirements, and least privilege. Use for AWS ElastiCache engineering, architecture, operations, or incident analysis when Redis OSS or Valkey compatibility is material to the task.
---

---
name: aws-elasticache-redis-analyze-sharding
description: Analyze ElastiCache cluster mode and shard topology, partition distribution, hash slots, hot shards, scaling, resharding, and cluster-aware client behavior. Use for AWS ElastiCache engineering, architecture, operations, or incident analysis when Redis OSS or Valkey compatibility is material to the task.
---

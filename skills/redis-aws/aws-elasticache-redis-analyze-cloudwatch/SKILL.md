---
name: aws-elasticache-redis-analyze-cloudwatch
description: Analyze Amazon ElastiCache CloudWatch metrics and logs for latency, engine CPU, server load, memory, cache hit ratio, evictions, connections, replication, and incident correlation. Use for AWS ElastiCache engineering, architecture, operations, or incident analysis when Redis OSS or Valkey compatibility is material to the task.
---

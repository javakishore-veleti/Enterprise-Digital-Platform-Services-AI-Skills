---
name: aws-elasticache-redis-analyze-session-state
description: Analyze ElastiCache distributed session-state patterns for stateless services, ECS/EKS workloads, TTLs, serialization, failover, and application auto-scaling. Use for AWS ElastiCache engineering, architecture, operations, or incident analysis when Redis OSS or Valkey compatibility is material to the task.
---

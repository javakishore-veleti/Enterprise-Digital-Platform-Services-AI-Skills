---
name: redis-analyze-connections
description: Analyze Azure Redis client connection lifecycle, pooling or multiplexing, reconnect behavior, TLS, timeouts, retry storms, connection limits, and client-side exhaustion. Use for Azure Redis engineering, architecture, operations, or incident analysis when Azure Managed Redis or Azure Cache for Redis is material to the task.
---

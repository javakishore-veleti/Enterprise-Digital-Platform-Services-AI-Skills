---
name: redis-analyze-pubsub
description: Analyze Redis Pub/Sub on Azure Redis for real-time notifications, subscriber lifecycle, reconnect behavior, message-loss expectations, and workload suitability. Use for Azure Redis engineering, architecture, operations, or incident analysis when Azure Managed Redis or Azure Cache for Redis is material to the task.
---

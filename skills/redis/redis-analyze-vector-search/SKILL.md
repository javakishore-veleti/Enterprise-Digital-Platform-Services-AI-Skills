---
name: redis-analyze-vector-search
description: Analyze Azure Managed Redis vector search and RediSearch configuration, embeddings, indexes, filters, retrieval latency, recall, and supported tier or clustering constraints. Use for Azure Redis engineering, architecture, operations, or incident analysis when Azure Managed Redis or Azure Cache for Redis is material to the task.
---

---
name: redis-analyze-persistence
description: Analyze Azure Managed Redis RDB and AOF persistence, durability expectations, recovery behavior, storage encryption, and performance tradeoffs. Use for Azure Redis engineering, architecture, operations, or incident analysis when Azure Managed Redis or Azure Cache for Redis is material to the task.
---

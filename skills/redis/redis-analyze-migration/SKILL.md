---
name: redis-analyze-migration
description: Analyze migration from retiring Azure Cache for Redis tiers to Azure Managed Redis, including compatibility, tier mapping, networking, authentication, clustering, modules, validation, cutover, and rollback. Use for Azure Redis engineering, architecture, operations, or incident analysis when Azure Managed Redis or Azure Cache for Redis is material to the task.
---

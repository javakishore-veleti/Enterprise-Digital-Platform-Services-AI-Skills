---
name: redis-analyze-transactions
description: Analyze Redis transactions, MULTI/EXEC, WATCH, pipelining, Lua or server-side atomic operations, concurrency, and correctness on Azure Redis. Use for Azure Redis engineering, architecture, operations, or incident analysis when Azure Managed Redis or Azure Cache for Redis is material to the task.
---

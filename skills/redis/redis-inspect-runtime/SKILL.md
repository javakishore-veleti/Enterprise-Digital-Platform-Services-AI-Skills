---
name: redis-inspect-runtime
description: Route Azure Redis investigations across Azure Managed Redis and legacy Azure Cache for Redis, resolving service type, tier, topology, environment, networking, identity, persistence, geo-replication, workload, and runtime evidence. Use for Azure Redis engineering, architecture, operations, or incident analysis when Azure Managed Redis or Azure Cache for Redis is material to the task.
---

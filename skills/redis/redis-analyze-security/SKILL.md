---
name: redis-analyze-security
description: Analyze Azure Redis security posture across identity, network isolation, TLS, access keys, permissions, auditability, encryption, and secret handling. Use for Azure Redis engineering, architecture, operations, or incident analysis when Azure Managed Redis or Azure Cache for Redis is material to the task.
---

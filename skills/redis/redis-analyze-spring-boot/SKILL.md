---
name: redis-analyze-spring-boot
description: Analyze Spring Boot and Java integration with Azure Redis including Lettuce or Jedis, Spring Cache, serialization, pooling, topology, authentication, timeouts, and resilience. Use for Azure Redis engineering, architecture, operations, or incident analysis when Azure Managed Redis or Azure Cache for Redis is material to the task.
---

---
name: redis-analyze-memory
description: Analyze Azure Redis memory usage, fragmentation, keyspace growth, TTL coverage, eviction behavior, large keys, and memory-pressure risk. Use for Azure Redis engineering, architecture, operations, or incident analysis when Azure Managed Redis or Azure Cache for Redis is material to the task.
---

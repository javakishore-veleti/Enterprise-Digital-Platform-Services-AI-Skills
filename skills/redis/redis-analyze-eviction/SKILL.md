---
name: redis-analyze-eviction
description: Analyze Azure Redis eviction policies, expirations, memory pressure, workload semantics, and data-loss expectations. Use for Azure Redis engineering, architecture, operations, or incident analysis when Azure Managed Redis or Azure Cache for Redis is material to the task.
---

---
name: redis-analyze-session-state
description: Analyze Azure Redis distributed session-state patterns for stateless applications and AKS workloads, including TTLs, affinity assumptions, failover, and serialization. Use for Azure Redis engineering, architecture, operations, or incident analysis when Azure Managed Redis or Azure Cache for Redis is material to the task.
---

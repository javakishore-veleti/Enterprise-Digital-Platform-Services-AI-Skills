---
name: redis-analyze-clustering
description: Analyze Azure Managed Redis clustering policy, shard topology, key distribution, cross-slot behavior, scaling constraints, and workload fit. Use for Azure Redis engineering, architecture, operations, or incident analysis when Azure Managed Redis or Azure Cache for Redis is material to the task.
---

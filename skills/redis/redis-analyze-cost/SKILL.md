---
name: redis-analyze-cost
description: Analyze Azure Managed Redis cost drivers including tier, memory, clustering, replicas, geo-replication, persistence, workload utilization, and right-sizing without weakening reliability. Use for Azure Redis engineering, architecture, operations, or incident analysis when Azure Managed Redis or Azure Cache for Redis is material to the task.
---

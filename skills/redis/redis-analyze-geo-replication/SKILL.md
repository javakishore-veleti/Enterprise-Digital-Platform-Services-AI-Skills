---
name: redis-analyze-geo-replication
description: Analyze Azure Managed Redis active geo-replication, regional topology, conflict behavior, application routing, failover strategy, latency, and recovery expectations. Use for Azure Redis engineering, architecture, operations, or incident analysis when Azure Managed Redis or Azure Cache for Redis is material to the task.
---

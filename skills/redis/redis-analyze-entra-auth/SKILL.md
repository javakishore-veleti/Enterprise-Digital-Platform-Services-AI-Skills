---
name: redis-analyze-entra-auth
description: Analyze Microsoft Entra authentication and managed-identity access to Azure Managed Redis, including Redis users, permissions, token lifecycle, and least privilege. Use for Azure Redis engineering, architecture, operations, or incident analysis when Azure Managed Redis or Azure Cache for Redis is material to the task.
---

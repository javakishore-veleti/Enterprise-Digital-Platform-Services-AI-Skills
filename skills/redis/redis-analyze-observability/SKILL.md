---
name: redis-analyze-observability
description: Analyze Azure Redis metrics, logs, connection audit evidence, alerts, application telemetry, and Datadog correlation for evidence-driven diagnosis. Use for Azure Redis engineering, architecture, operations, or incident analysis when Azure Managed Redis or Azure Cache for Redis is material to the task.
---

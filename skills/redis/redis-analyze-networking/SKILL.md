---
name: redis-analyze-networking
description: Analyze Azure Redis Private Link or private endpoints, VNet/DNS/routing, firewall exposure, TLS, AKS connectivity, and network-related latency or failures. Use for Azure Redis engineering, architecture, operations, or incident analysis when Azure Managed Redis or Azure Cache for Redis is material to the task.
---

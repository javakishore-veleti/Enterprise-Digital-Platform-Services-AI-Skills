---
name: redis-analyze-performance
description: Analyze Azure Redis throughput and latency using command patterns, server load, CPU, memory, network, connection counts, hot keys, large values, and client behavior. Use for Azure Redis engineering, architecture, operations, or incident analysis when Azure Managed Redis or Azure Cache for Redis is material to the task.
---

---
name: redis-analyze-streams
description: Analyze Redis Streams on Azure Redis including consumer groups, pending entries, acknowledgements, lag, trimming, retries, idempotency, and delivery semantics. Use for Azure Redis engineering, architecture, operations, or incident analysis when Azure Managed Redis or Azure Cache for Redis is material to the task.
---

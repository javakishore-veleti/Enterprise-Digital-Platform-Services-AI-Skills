---
name: redis-analyze-cache
description: Analyze Azure Redis cache behavior including cache-aside, TTLs, hit ratio, misses, stale data, stampedes, key design, invalidation, and backend interaction. Use for Azure Redis engineering, architecture, operations, or incident analysis when Azure Managed Redis or Azure Cache for Redis is material to the task.
---

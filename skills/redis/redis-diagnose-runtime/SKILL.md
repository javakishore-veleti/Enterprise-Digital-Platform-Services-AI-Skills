---
name: redis-diagnose-runtime
description: Diagnose Azure Redis runtime failures across clients, connections, latency, timeouts, memory, CPU, server load, network, authentication, clustering, failover, and dependent applications. Use for Azure Redis engineering, architecture, operations, or incident analysis when Azure Managed Redis or Azure Cache for Redis is material to the task.
---

---
name: spring-boot-observability-trace-request
description: Trace a Spring Boot request across logs, metrics, traces, correlation IDs, downstream spans, and service boundaries. Use for Spring Boot observability engineering, architecture, validation, or runtime diagnosis.
---

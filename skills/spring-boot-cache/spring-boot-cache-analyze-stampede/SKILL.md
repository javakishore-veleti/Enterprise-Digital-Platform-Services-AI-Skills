---
name: spring-boot-cache-analyze-stampede
description: Analyze cache stampedes, dogpiles, hot keys, request coalescing, synchronization, TTL jitter, and backend protection. Use for Spring Boot cache engineering, architecture, or runtime diagnosis.
---

# Analyze Cache Stampede

---
name: spring-boot-cache-analyze-invalidation
description: Analyze cache invalidation, eviction timing, stale data, domain events, and consistency across service instances. Use for Spring Boot cache engineering, architecture, or runtime diagnosis.
---

---
name: spring-boot-cache-analyze-redis
description: Analyze Spring Boot Redis cache integration, serialization, connection factories, cache manager configuration, and runtime failures. Use for Spring Boot cache engineering, architecture, or runtime diagnosis.
---

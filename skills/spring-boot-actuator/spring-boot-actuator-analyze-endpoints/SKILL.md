---
name: spring-boot-actuator-analyze-endpoints
description: Analyze Actuator endpoint exposure, management port/base path, access controls, and operational risk. Use for Spring Boot actuator engineering, architecture, validation, or runtime diagnosis.
---

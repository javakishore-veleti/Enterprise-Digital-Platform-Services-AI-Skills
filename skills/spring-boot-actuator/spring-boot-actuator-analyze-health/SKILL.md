---
name: spring-boot-actuator-analyze-health
description: Analyze Spring Boot Actuator health contributors, readiness, liveness, dependency health, and Kubernetes probe behavior. Use for Spring Boot actuator engineering, architecture, validation, or runtime diagnosis.
---

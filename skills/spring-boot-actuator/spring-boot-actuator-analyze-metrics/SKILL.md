---
name: spring-boot-actuator-analyze-metrics
description: Analyze Actuator metrics endpoints, meter availability, tags, custom metrics, and operational interpretation. Use for Spring Boot actuator engineering, architecture, validation, or runtime diagnosis.
---

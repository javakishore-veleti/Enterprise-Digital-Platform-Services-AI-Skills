---
name: spring-boot-actuator-analyze-config
description: Analyze Actuator environment/configuration diagnostics, property origins, config precedence, and safe exposure practices. Use for Spring Boot actuator engineering, architecture, validation, or runtime diagnosis.
---

# Analyze Config Diagnostics
